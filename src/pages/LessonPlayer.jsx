  ...
  return (
    <div className="player player-vertical">
      <div className="p-topbar">
        ...
        <div style={{ flex: 1 }}>
          <span className="p-badge">Módulo {mod.number} · Lição {lesson.number}</span>
        </div>
      </div>
      ...
      <div className="p-wrap p-body-vertical">
        ...
        {/* 5. COMPLETAR O DIÁLOGO — DRAG AND DROP */}
        <Reveal className="v-section">
        ...
        {/* NOVO: segunda frase, mais difícil */}
        <Reveal className="v-section">
        ...
        <Reveal className="v-section">
          ...
          {c.listenType.map((it, i) => (
            <div key={i} style={{ marginBottom: 20 }}>
              <ListenType text={it.text} hintPt={it.hintPt} />
            </div>
          ))}
        </Reveal>
        ...
        <Reveal className="v-section">
          ...
          <Recorder prompt="Nice to meet you!" />
        </Reveal>
        ...
        <Reveal className="v-section">
          ...
          <Recorder prompt="Hi! My name is ____. Nice to meet you!" />
        </Reveal>
              ...
              {mc.options.map((o, j) => {
                ...
                return (
                  <button
                    ...
                    onClick={() => setMcAnswers((a) => ({ ...a, [key]: letter }))}
                  >
                    {o}
                  </button>
                );
